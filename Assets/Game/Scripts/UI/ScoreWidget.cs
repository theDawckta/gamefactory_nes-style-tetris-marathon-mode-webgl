...
public class ScoreWidget : MonoBehaviour
{
    ...
    public void Initialize(VisualElement scoreRegion, PlayfieldController controller)
    {
        if (scoreRegion == null) return;
    ...
    {
        if (_valueLabel != null)
            _valueLabel.text = score.ToString();
    }
